    ...
    render() {
        ...
        return(
            <div className="issue card mb-4 shadow-sm">
                <h4><a href={`${this.props.issue.html_url}`}>{this.props.issue.name}</a></h4>
                <div className="text-muted">
                    открыт <a href={`${this.props.issue.user.html_url}`} >{this.props.issue.user.login}</a>
                ...
                {this.state.detailed ? (
                    <div className="issue-more-info">
                        ...
                        <div className="issue-description">{this.props.issue.description}</div>
                ...
                <div className="issue-more-button">
                    {this.props.issue.description ? this.state.detailed ? <FontAwesomeIcon onClick={this.showDetailed} icon="chevron-up" />
